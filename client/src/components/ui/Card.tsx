    ...
    ({ children, className, hover, padding = 'md', ...props }, ref) => {
        ...
        return (
            <div
                ref={ref}
                className={cn(
                    'rounded-xl bg-white dark:bg-surface-dark shadow-sm border border-gray-200 dark:border-gray-800',
...
export const CardTitle = forwardRef<HTMLHeadingElement, CardTitleProps>(
  ({ children, className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn('text-xl font-bold text-gray-900 dark:text-white leading-tight', className)}
      {...props}
    >
      {children}
    </h3>
