...
export const CreateSpaceCard = () => (
  <article className="group flex flex-col items-center justify-center bg-transparent border-2 border-dashed border-gray-200 dark:border-gray-800 hover:border-primary/50 hover:bg-white/50 dark:hover:bg-white/5 rounded-xl p-5 transition-all duration-300 h-full cursor-pointer min-h-[200px]">
